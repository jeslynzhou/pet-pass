...
const INITIAL_CHECKLIST = [
  {
    ...
    desc: "Universal scanner-compatible microchip implanted before rabies vaccination. Required for dog identification.",
    status: "pending",
    type: "doc",
    fileName: null,
  },
  {
    ...
    desc: "Complete online form. Receipt valid for single entry on arrival date listed. Must include dog photo and microchip number.",
    status: "pending",
    type: "doc",
    fileName: null,
  },
  {
    id: "3",
    title: "Certification of Foreign Rabies Vaccination",
    desc: "Form completed by veterinarian and endorsed by official government veterinarian. Must be completed within 30 days of travel.",
    status: "pending",
    type: "doc",
    fileName: null,
  },
  {
    id: "4",
    title: "Rabies Serology Titer Report",
    desc: "Blood test from CDC-approved lab proving rabies immunity. Sample drawn 30+ days after first vaccination, 28+ days before travel.",
    status: "pending",
    type: "doc",
    fileName: null,
  },
  {
    id: "5",
    title: "CDC-Registered Facility Reservation",
    desc: "Required reservation at CDC animal care facility for examination and revaccination. Include 28-day quarantine if no valid titer.",
    status: "pending",
    type: "doc",
    fileName: null,
  },
  {
    id: "6",
    title: "Current Dog Photo",
    desc: "Recent photo showing dog's face and body. For dogs under 1 year, photo must be taken within 15 days of travel.",
    status: "pending",
    type: "photo",
    fileName: null,
  },
  {
    id: "7",
    title: "Airline Carrier Approval",
    desc: "Confirm airline pet travel policies and carrier requirements. Book pet travel with airline if applicable.",
    status: "pending",
    type: "doc",
    fileName: null,
  },
  {
    ...
    desc: "Dog must appear healthy upon arrival. Get veterinary health clearance before travel.",
    status: "pending",
    type: "doc",
    fileName: null,
  },
