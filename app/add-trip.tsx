...
const ORIGINS = ['Santiago, Chile', 'Buenos Aires, Argentina', 'Lima, Peru', 'Bogota, Colombia', 'Sao Paulo, Brazil'];
const DESTINATIONS = ['San Francisco, USA', 'Miami, USA', 'New York, USA', 'Madrid, Spain', 'Paris, France'];
const AIRLINES = ['LATAM', 'United Airlines', 'Delta', 'American Airlines', 'Sky Airline', 'JetSMART'];
    ...
    <View style={styles.inputGroup}>
      ...
      >
        <View style={styles.dropdownContent}>
          ...
          <Text style={[styles.dropdownText, !value && { color: COLORS.textGray }]}>
            {value || `Select ${label}`}
          </Text>
        </View>
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.createButton} onPress={generateChecklistAndSave}>
